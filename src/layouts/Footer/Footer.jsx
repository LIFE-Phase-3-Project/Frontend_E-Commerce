export default function Footer() {
    return (
      <footer className=" mx-auto mb-0 bg-custom-green rounded-t-lg shadow m-4 dark:bg-gray-800 w-full">
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 gap-y-8 md:gap-8 py-10 max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
                <div class="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                    ...
                    <p class="py-8 text-sm text-cream lg:max-w-xs text-center lg:text-left">Trusted from more than 5 million customers. Have any questions ?</p>
                    <a href="javascript:;"  class="py-2.5 px-5 h-9 block w-fit bg-custom-purple rounded-full shadow-sm text-xs text-white mx-auto transition-all  duration-500 hover:bg-on-hover-purple lg:mx-0">
                        Contact us
                    </a>
                </div>
               
                <div class="lg:mx-auto text-left ">
                    <h4 class="text-xl text-cream font-medium mb-7">Pagedone</h4>
                    <ul class="text-sm  transition-all duration-500">
                        <li class="mb-6"><a href="javascript:;"  class="text-cream hover:text-gray-900">Home</a></li>
                        <li class="mb-6"><a href="javascript:;"  class=" text-cream hover:text-gray-900">About</a></li>
                        <li><a href="javascript:;"  class=" text-cream hover:text-gray-900">Company</a></li>
                    </ul>
                </div>
              
                <div class="lg:mx-auto text-left ">
                    <h4 class="text-xl text-cream font-medium mb-7">Products</h4>
                    <ul class="text-sm  transition-all duration-500">
                        <li class="mb-6"><a href="javascript:;"  class="text-cream hover:text-gray-900">Manifacturing</a></li>
                        <li class="mb-6"><a href="javascript:;"  class=" text-cream hover:text-gray-900">Returns</a></li>
                        <li><a href="javascript:;"  class=" text-cream hover:text-gray-900">Billing</a></li>
                    </ul>
                </div>
            
                <div class="lg:mx-auto text-left ">
                    <h4 class="text-xl text-cream font-medium mb-7">Support</h4>
                    <ul class="text-sm  transition-all duration-500">
                        <li class="mb-6"><a href="javascript:;"  class="text-cream hover:text-gray-900">Customer Support</a></li>
                        <li class="mb-6"><a href="javascript:;"  class=" text-cream hover:text-gray-900">Terms & Conditions</a></li>
                        <li ><a href="javascript:;"  class=" text-cream hover:text-gray-900">Privacy Policy</a></li>
                    </ul>
                </div>
             
                <div class="lg:mx-auto text-left ">
                    <h4 class="text-xl text-cream font-medium mb-7">Subscribe</h4>
                    <p class="text-sm text-cream leading-6 mb-7">Subscribe to get the latest news from us</p>
                    <a href="javascript:;"  class="flex items-center justify-center gap-2 border border-custom-purple rounded-full py-3 px-6 w-fit lg:mx-0  text-sm text-custom-purple font-semibold transition-all duration-500 hover:bg-on-hover-purple hover:text-cream">Subscribe
            ...
            <div class="py-7 border-t border-gray-200">
                <div class="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                    <span class="text-sm text-cream ">©<a href="https://pagedone.io/">pagedone</a> 2024, All rights reserved.</span>
