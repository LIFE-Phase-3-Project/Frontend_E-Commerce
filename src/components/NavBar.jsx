        ...
        <div className="relative flex h-16 items-center justify-between">
                ...
                {navigation.map((item) => (
                  <a
                    ...
                    className={classNames(
                      item.current ? 'bg-on-hover-green text-cream' : 'text-cream hover:bg-on-hover-green hover:text-cream',
          ...
          <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            ...
            <Menu as="div" className="relative ml-3">
              ...
              >
                <MenuItem>
                  <a href="#" className="block px-4 py-2 text-sm text-cream data-[focus]:bg-gray-100">
                    Your Profile
                  </a>
                </MenuItem>
                <MenuItem>
